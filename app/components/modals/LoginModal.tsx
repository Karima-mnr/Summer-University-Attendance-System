...
import { X, Shield, AlertCircle, CheckCircle, Sparkles, Lock, ArrowRight, Fingerprint } from 'lucide-react';
        ...
        <>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <motion.div 
                className="absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-[#0B6B3A] via-[#F2891D] to-[#CE1126]"
                animate={{ 
              ...
              <div className="relative p-8 pt-10">
                ...
                <div className="flex justify-center mb-6">
                  ...
                  >
                    <div className="absolute inset-0 rounded-full bg-gradient-to-br from-[#0B6B3A] to-[#1a8a4a] blur-2xl opacity-20 animate-pulse" />
                    <div className="relative flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-[#0B6B3A] to-[#1a8a4a] shadow-lg shadow-[#0B6B3A]/30">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        {[...Array(6)].map((_, i) => (
                          <motion.div
                            ...
                            animate={{
                              ...
                              backgroundColor: i < fullCode.length 
                                ? '#0B6B3A' 
                                : error
                                  ? '#fca5a5'
                                  : '#e2e8f0'
                  ...
                  <div className="flex gap-3 pt-2">
                    ...
                    <motion.button
                      ...
                      className="group relative flex-1 overflow-hidden rounded-2xl bg-gradient-to-br from-[#16231d] to-[#21402f] px-4 py-3.5 text-sm font-semibold text-black shadow-lg shadow-[#0B6B3A]/30 transition-all hover:shadow-xl hover:shadow-[#0B6B3A]/40 disabled:opacity-50 disabled:hover:shadow-lg"
                    >
                      {loading ? (
                        ...
                        <span className="flex items-center justify-center gap-2">
                          ...
                          <ArrowRight size={18} className={`transition-transform group-hover:translate-x-1 ${!isComplete && 'opacity-50'}`} />
                        </span>
                      )}
                    </motion.button>
                  </div>
